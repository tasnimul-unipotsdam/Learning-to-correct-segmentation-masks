...
class WritingRecord:
    ...
    def __init__(self):
        self.original_img_dir = '../test_data/Test_dataset_253_subjects/*'
        self.corrupt_images = glob.glob('../test_data/test_images_corrupted/*')
        self.record_path = '../test_data/test_records'
